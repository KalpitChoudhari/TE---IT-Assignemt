...
INSERT INTO `Category` VALUES ('1','Books'),('2','Pens'),('3','Manuals'),('4','Scale');
...
INSERT INTO `Order_Record` VALUES (1,'1','1','2019-07-08',2,100.00),(1,'1','2','2019-07-08',2,20.00),(3,'2','3','2019-07-10',5,75.00),(4,'3','2','2019-07-15',2,20.00),(5,'4','4','2019-07-17',10,500.00);
...
CREATE TABLE `Product` (
  ...
  KEY `fk_cid` (`c_id`),
  CONSTRAINT `fk_cid` FOREIGN KEY (`c_id`) REFERENCES `Category` (`c_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Product` VALUES ('1','Note Books',18,50.00,'1'),('2','Pen',16,10.00,'2'),('3','Scale',15,15.00,'4'),('4','File',10,50.00,'3');
...
-- Dump completed on 2019-07-17 13:14:06
